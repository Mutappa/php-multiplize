<?php 
    ...
    //add all listings
    $user = $_SESSION['user'];
    $Sellers = include('../../database/fetch-data/fetch_sellers.php');
    // var_dump($listings);
    // die;
...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com/css?family=Monsterrat">
    <!-- add fonts folder -->
    <link rel="stylesheet" href="../../assets/css/font-awesome.min.css">
        <!-- Latest compiled and minified CSS -->
    <title>Sellers Listings</title>
            ...
            <div class="content_box">
                <div class="content_header">
                    ...
                    <div class="add_listing_form">
                        <a href="../forms/sellers_form.php"><i class="fa-solid fa-plus"></i> Add Listing </a>
                    </div>
                </div>
                <div class="listing_content">
                    <table cellspacing="0" id="listingTable">
                        ...
                        <tbody>
                            <?php foreach($Sellers as $index => $user){?>
                                <tr>
                                    <td><?= $index + 1?></td>
                                    ...
                                    <td class="options_box">
                                            <a href="/php-multiplize/html/forms/edit_sellers.php?id=<?= $user['id'] ?>" class="dropdown-item edit_icon"><i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="../../database/delete-data/sellers_del.php" class="delete_listing del_icon del_sellers" data-userid="<?= $user['id'] ?>">
